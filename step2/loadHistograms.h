...
const char* filePath = "../mergedHists/Nominal_Dec8_combo/";
const int variations = 39;
const char * variationTag[variations]= {"","_pPb5JESUP1p5","_pPb5JESDOWN1p5","_pp7JESUP3","_pp7JESDOWN3","_pPb5JESUP3","_pPb5JESDOWN3","_pp2JER5","_pp7JER5","_pPb5JER5","_pp2JER2","_pp7JER2","_pPb5JER2","_NoTrackCorr","_pp2JESUP1","_pp2JESDOWN1","_pp7JESUP1","_pp7JESDOWN1","_pPb5JESUP1","_pPb5JESDOWN1","_pp2JESUP2","_pp2JESDOWN2","_pp7JESUP2","_pp7JESDOWN2","_pPb5JESUP2","_pPb5JESDOWN2","_60DegreeCone","_ChargePlus","_ChargeMinus","_XtScaled","_NoChargeCut","_lowPU","_highPU","_midPU","_pprefJESUP2p5","_pprefJESDOWN2p5","_ppref5JER5","_pprefJESUP1p5","_pprefJESDOWN1p5"};

// jet pt boundaries
const int FF_Bins = 6;
double FF_Bound[FF_Bins+1] = {60,80,100,120,140,200,300};
//const int FF_Bins = 1;
//double FF_Bound[FF_Bins+1] = {60,1000};
...
void loadHistos(int v, int UEtype)
{
  ...
  if(v==7 || v==10 || v==13 || v==14 || v==15 || v==20 || v==21 || v==26 || v==27 || v==28 || v==29 || v==30) pp2Tag = variationTag[v];
  if(v==3 || v==4 || v==8 || v==11 || v==13 || v==16 || v==17 || v==22 || v==23 || v==26 || v==27 || v==28 || v==29 || v==30 || v==31 || v==32 || v==33) pp7Tag = variationTag[v];
  if(v==1 || v==2 || v==5 || v==6 || v==9 || v==12 || v==13 || v==18 || v==19 || v==24 || v==25 || v==26 || v==27 || v==28 || v==29 || v==30 || v==31 || v==34 || v==35 || v==36 || v==37 || v==38) pPb5Tag = variationTag[v];
