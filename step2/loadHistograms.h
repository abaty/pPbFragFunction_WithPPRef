...
const char* filePath = "../mergedHists/processed_2016_10_11__15_10_12/";
...
void loadHistos(int v, int UEtype)
{
  ...
  if(v==5 || v==6 || v==9 || v==12 || v==13 || v==18 || v==19 || v==24 || v==25 || v==26 || v==27 || v==28 || v==29 || v==30 || v==34 || v==35 || v==36) pPb5Tag = variationTag[v];
