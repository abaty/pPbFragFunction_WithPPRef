...
const int trkBins=24;
const double yAxis[trkBins+1] = {0.5, 0.63, 0.77,  1.03,1.38, 1.84, 2.46, 3.29,  4.40, 5.88,  7.87,  10.52, 14.06,  18.8, 25.13,  33.58,  44.89,  60, 80, 100, 120, 140, 200, 300, 400};
...
void Interpolate()
{
  ...
  {
    if((v<3 || v>4) && v!=7 && v!=8 && v!=10 && v!=11 && v!=12 && (v<14 || v>23)&& v!=24 && v!=25 && v!=29 && v!=27 && v!=28 && (v<32 || v>33))
    {
      makeFF(v,0);
      if(v!=26) makeFF(v,3);
      if(v!=26) makeFF(v,2);
